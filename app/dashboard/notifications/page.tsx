...
import { Bell, Mail, MessageCircle, Package, ShieldAlert } from "lucide-react"
...
function typeMeta(type: NotificationType) {
  switch (type) {
    ...
    case "chat":
      return { icon: MessageCircle, label: "Chat" as const }
    case "wallet":
    default:
...
export default function NotificationsPage() {
  const { notifications, refreshNotifications, markNotificationRead, markAllNotificationsRead } = useAppStore()
  ...
  const active: NotificationDTO | null = useMemo(
    () => (activeId ? notifications.find((n) => n.id === activeId) ?? null : null),
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
            <div>
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                Important updates about your deals, shipments, chats and wallet activity.
              </p>
            </div>
                      ...
                      <div className="flex items-start justify-between gap-3">
                        <div className="min-w-0">
                          ...
                          <div className="mt-3 flex items-center gap-2 text-xs text-muted-foreground">
                            <span>{label}</span>
                            <span>•</span>
                            <span>{formatDealDateTime(n.createdAt)}</span>
                          </div>
                        </div>
                      ...
                      {filtered.map((n) => {
                        ...
                        return (
                          <TableRow key={n.id}>
                            ...
                            <TableCell className="text-muted-foreground">{formatDealDateTime(n.createdAt)}</TableCell>
            ...
            <>
              ...
              <div className="space-y-3 text-sm">
                <div className="flex items-center justify-between gap-3">
                  ...
                  <span className="font-medium text-foreground">{formatDealDateTime(active.createdAt)}</span>
                </div>
                <div className="flex items-center justify-between gap-3">
