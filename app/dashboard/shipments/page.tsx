...
function ShipmentsPageContent() {
  ...
  return (
    <>
      ...
      {/* Hero Banner */}
      <div className="relative overflow-hidden bg-card px-8 py-6">
        ...
        <div className="relative z-10 flex items-center justify-between">
          ...
          <button
            ...
            className="flex items-center gap-2 rounded-xl bg-primary px-6 py-3 font-semibold text-primary-foreground shadow-lg transition-all hover:shadow-xl"
          >
